      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-right-spacing">
            ...
            <figure class="image top-spacing">
               <img src="<?php echo e(asset('assets/images/logistic-image02.jpg')); ?>" alt="Image">
            </figure>
            <!-- end image -->
         </div>
         <!-- end col-6 -->
         <div class="col-lg-6 col-left-spacing">
            <figure class="image bottom-spacing">
               <img src="<?php echo e(asset('assets/images/logistic-image01.jpg')); ?>" alt="Image">
            </figure>
            <!-- end image -->
            <figure class="image">
               <img src="<?php echo e(asset('assets/images/logistic-image03.jpg')); ?>" alt="Image">
            </figure>
            <!-- end image -->
         </div>
         <!-- end col-6 -->
...
<?php echo $__env->make('Frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u461878610/domains/track.crossbordercargologistics.com/public_html/resources/views/Frontend/Logistics.blade.php ENDPATH**/ ?>